        ...
        >
            ...
            <input
              ...
              placeholder="Password"
					  />
					  {errors.password?.type === "required" && <p role="alert" className="text-red-600">Password Required</p>}
					  {errors.password?.type === "minLength" && <p role="alert" className="text-red-600">Password is 6 Carecter is Longer</p>}
            <div>
